...
/**
 * The most general implementation of the {@link edu.nd.nina.Graph} interface.
...
public abstract class AbstractBaseGraph<V, E> extends AbstractGraph<V, E>
	 ...
	 * is created with a default implementation which always supplies an
	...
	public Object clone() {
		try {
			...
			AbstractBaseGraph<V, E> newGraph = TypeUtil.uncheckedCast(

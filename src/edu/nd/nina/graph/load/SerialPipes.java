...
public class SerialPipes extends Pipe {
	...
	public SerialPipes newSerialPipesFromSuffix(
			Predicate testForStartingNewPipes) {
		int i = 0;
		while (i < pipes.size())
	...
	// If you need an augmented pipe, you can make a new SerialPipes containing
	// this one.
	...
	public Pipe getPipe(int index) {
		...
		try {
			...
			System.err.println("Error getting pipe. Index = " + index + ".  "
					+ e.getMessage());
		}
		return retPipe;
	}

...
import edu.nd.nina.experimental.equivalence.EquivalenceComparator;
import edu.nd.nina.experimental.equivalence.EquivalenceComparatorChain;
import edu.nd.nina.experimental.equivalence.EquivalenceComparatorChainBase;
import edu.nd.nina.experimental.equivalence.EquivalenceSet;
import edu.nd.nina.experimental.equivalence.EquivalenceSetCreator;
import edu.nd.nina.experimental.equivalence.UniformEquivalenceComparator;
import edu.nd.nina.experimental.isomorphism.comparators.*;
    ...
    extends TestCase
{
    ...
    public void testUniformGroup()
    {
        ...
        testOneComparator(
            new edu.nd.nina.experimental.isomorphism.comparators.Mod3GroupComparator(),
            3);
    }
    ...
    public void testOddEvenGroup()
    {
        ...
        // nubmers");
        testOneComparator(
            new edu.nd.nina.experimental.isomorphism.comparators.OddEvenGroupComparator(),
            2);
